...
def train(cfg: DictConfig, ckpt_ft: Optional[str] = None) -> None:
    ...
    logger.info(f"this is the target'{cfg.data._target_}' ")
    logger.info(f"this is the cwd'{os.getcwd()}' ")
    data_module = instantiate(cfg.data)  #class type BABELDataModule in sinc.data.babel
